"""
GIVEN. This file ships in the starter repository. Trainees call `resolve_as_at`
from referral.py and publish.py, and must choose the right DATE at each call -
that is the part being assessed. Inferring succession from ODS adjacency is not.
